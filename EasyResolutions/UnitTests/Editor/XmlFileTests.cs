//-----------------------------------------------------------------------
// <copyright file="XmlFileTests.cs" company="https://github.com/marked-one/EasyResolutions">
...
namespace EasyResolutions.Tests
{
    ...
    internal class XmlFileTests : TestsBase
    {
        ...
        private void CreateEmptyFile()
        {
            ...
            var relativePath = Path.Combine("Assets/EasyResolutions/Resources", XmlFile.FileName);
            AssetDatabase.ImportAsset(relativePath);
        }

        private string GetFilePath()
        {
            var directory = Path.Combine(Application.dataPath, "EasyResolutions/Resources");
