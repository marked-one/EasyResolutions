//-----------------------------------------------------------------------
// <copyright file="AvailableResolutionsTests.cs" company="https://github.com/marked-one/EasyResolutions">
...
namespace EasyResolutions.Tests
{
    ...
    internal class AvailableResolutionsTests : TestsBase
    {
        ...
        private class WrongXElement
        {
            public static IEnumerable TestCases
            {
                get
                {
                    ...
                    yield return new TestCaseData(new XElement("WrongElement")).SetName("'EasyResolutions' element does not exist.");
                    yield return new TestCaseData(new XElement("EasyResolutions")).SetName("'EasyResolutions' element does exist, but 'Scenes' and 'Resolutions' elements does not exist.");
                    yield return new TestCaseData(new XElement("EasyResolutions", new XElement("Scenes"))).SetName("'EasyResolutions' and 'Scenes' elements does exist, but 'Resolutions' element does not exist.");
                    yield return new TestCaseData(new XElement("EasyResolutions", new XElement("Resolutions"))).SetName("'EasyResolutions' and 'Resolutions' elements does exist, but 'Scenes' element does not exist.");
                    yield return new TestCaseData(new XElement("EasyResolutions", new XElement("Scenes", new XElement("Scene")), new XElement("Resolutions"))).SetName("'EasyResolutions', 'Scenes' and 'Resolutions' elements does exist, but 'Scenes' contains incorrect 'Scene' element.");
                    yield return new TestCaseData(new XElement("EasyResolutions", new XElement("Scenes", new XElement("Scene", new XAttribute("name", sceneName), new XElement("Resolution"))), new XElement("Resolutions"))).SetName("'EasyResolutions', 'Resolutions' and 'Scenes'+'Scene' elements does exist, but 'Scene' contains incorrect 'Resolution' element.");
                    yield return new TestCaseData(new XElement("EasyResolutions", new XElement("Scenes"), new XElement("Resolutions", new XElement("Resolution")))).SetName("'EasyResolutions', 'Scenes' and 'Resolutions' elements does exist, but 'Resolutions' contains incorrect 'Resolution' element.");
                }
            }
        }

        [TestCase(TestName = "'EasyResolutions' contains 'Scenes' and 'Resolutions' elements and they are empty.")]
        [Category("Easy Resolutions")]
        public void FromXmlReturnsTrueAndReadsNoResolutionsIf()
        {
            var xml = new XElement("EasyResolutions", 
                                   new XElement("Scenes"), 
        ...
        [TestCase(TestName = "'EasyResolutions' contains 'Scenes' and 'Resolutions' elements; 'Scenes' contains valid 'Scene' with 'Resolution'; 'Resolutions' contains valid 'Resolution' element.")]
        [Category("Easy Resolutions")]
        ...
        public void ToXmlReturnsXElementOfValidStructureButWithoutScenesAndResolutionsIf()
        {
            ...
            Assert.That(xml.Name.LocalName, Is.EqualTo("EasyResolutions"), "XML root should have been 'EasyResolutions'.");
