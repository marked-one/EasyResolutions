//-----------------------------------------------------------------------
// <copyright file="FillAspectRatioResolutionComparisonComponent.cs" company="https://github.com/marked-one/ScenesAndResolutionsPicker">
...
{
    /// <summary>
    /// Represents the comparison of <see cref="EasyResolutions.Resolution"/>'s A and B aspect ratios,
    /// and their check against the game resolution aspect ratio, to find the one, which best "fills" the
    /// game window. This means, that the algorithm will prefer the one, which covers the whole game window 
    /// rectangle (thus, the scene may be cropped), or at least the one, which covers more area of the 
    /// rectangle, over others. 
    /// </summary>
    public class FillAspectRatioResolutionComparisonComponent : IResolutionComparisonComponent
    {
        /// <summary>
        ...
        /// A, B and game resolution all have landscape orientation, the resolution with greater 
        ...
        /// "bigger". If resolution A, B and game resolution all are portrait, the resolution with
        ...
        public bool Compare(out int result, Resolution resolutionA, Resolution resolutionB, UnityEngine.Resolution gameResolution)
        {
            ...
            bool needGreaterAspect = gameResolution.IsLandscape() && bothAAndBAreLandscape;
            ...
            (gameResolution.IsLandscape() && bothAAndBArePortrait) || 
                ...
                (gameResolution.IsPortrait() && bothAAndBArePortrait);
