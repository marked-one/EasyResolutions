...
Then, in the Editor, you generate Easy Resolutions XML file from the menu: Assets->Create->Easy Resolutionsile. The file appears in EasyResolutions/Resources folder. Only scenes added to the Build Settings and marked as enabled are present in it.

Finally, in your scripts you load scenes using the following code: Application.LoadLevel("SceneName".PickResolution());. 
...
5. Open the script EasyResolutions/Example/Scripts/First.cs to see the code.
