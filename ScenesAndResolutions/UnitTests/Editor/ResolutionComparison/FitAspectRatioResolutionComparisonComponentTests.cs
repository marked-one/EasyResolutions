//-----------------------------------------------------------------------
// <copyright file="FitAspectRatioResolutionComparisonComponentTests.cs" company="https://github.com/marked-one/ScenesAndResolutionsPicker">
...
namespace ScenesAndResolutions.Tests
{
    ...
    [TestFixture]
    internal class FitAspectRatioResolutionComparisonComponentTests : TestsBase
    {
        ...
        {
            var component = new FitAspectRatioResolutionComparisonComponent();
            int result;
