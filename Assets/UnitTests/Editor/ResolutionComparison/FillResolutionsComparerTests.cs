//-----------------------------------------------------------------------
// <copyright file="FillResolutionComparerTests.cs" company="https://github.com/marked-one/EasyResolutions">
...
namespace EasyResolutions.Tests
{
		...
		internal class FillResolutionComparerTests : TestsBase
		{
				...
				[TestCase(711, 400, 1136, 640, 768, 1366, TestName="(10) aspect ratio factors of A and B are nearly equal, both resolutions A and B are lower than the game resolution, and resolution A is lower than resolution B.")]
				[TestCase(1136, 640, 711, 400, 1366, 768, TestName="(11) aspect ratio factors of A and B are nearly equal, both resolutions A and B are lower than the game resolution, and resolution B is lower than resolution A.")]
				[TestCase(1136, 640, 1366, 768, 400, 711, TestName="(12) aspect ratio factors of A and B are nearly equal, both resolutions A and B are greater than the game resolution, and resolution B is greater than resolution A.")]
				[TestCase(1136, 640, 1366, 768, 711, 400, TestName="(13) aspect ratio factors of A and B are nearly equal, both resolutions A and B are greater than the game resolution, and resolution B is greater than resolution A.")]
				[TestCase(711, 400, 1366, 768, 1136, 640, TestName="(14) aspect ratio factors of A and B are nearly equal, all resolutions are of same direction, resolution A is lower than game resolution and resolution B is greater than the game resolution B.")]
				[Category("Easy Resolutions")]
				...
				[TestCase(1136, 640, 711, 400, 768, 1366, TestName="(10) aspect ratio factors of A and B are nearly equal, both resolutions A and B are lower than the game resolution, and resolution B is lower than resolution A.")]
				[TestCase(711, 400, 1136, 640, 1366, 768, TestName="(11) aspect ratio factors of A and B are nearly equal, both resolutions A and B are lower than the game resolution, and resolution A is lower than resolution B.")]
				[TestCase(1366, 768, 1136, 640, 400, 711, TestName="(12) aspect ratio factors of A and B are nearly equal, both resolutions A and B are greater than the game resolution, and resolution A is greater than resolution B.")]
				[TestCase(1366, 768, 1136, 640, 711, 400, TestName="(13) aspect ratio factors of A and B are nearly equal, both resolutions A and B are greater than the game resolution, and resolution A is greater than resolution B.")]
				[TestCase(1366, 768, 711, 400, 1136, 640, TestName="(14) aspect ratio factors of A and B are nearly equal, all resolutions are of same direction, resolution A is greater than game resolution and resolution B is lower than the game resolution B.")]
				[Category("Easy Resolutions")]
