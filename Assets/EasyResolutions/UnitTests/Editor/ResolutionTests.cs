//-----------------------------------------------------------------------
// <copyright file="ResolutionTests.cs" company="https://github.com/marked-one/EasyResolutions">
...
namespace EasyResolutions.Tests
{
    ...
    internal class ResolutionTests : TestsBase
    {
        ...
        // Hash codes for different resolutions may be equal, so checking only equal resolutions.
        ...
        [TestCaseSource(typeof(TestCases), "TwoEqualResolutions")]
        [Category("Easy Resolutions")]
        public void EqualsReturnsTrueIf(int widthA, int heightA, int widthB, int heightB)
        {
            var resolutionA = new Resolution(widthA, heightA);
            var resolutionB = new Resolution(widthB, heightB);
        ...
        [Category("Easy Resolutions")]
        public void EqualsReturnsFalseIf(int widthA, int heightA, int widthB, int heightB)
        {
            var resolutionA = new Resolution(widthA, heightA);
            var resolutionB = new Resolution(widthB, heightB);
            var returned = resolutionA.Equals(resolutionB);
