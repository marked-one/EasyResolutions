//-----------------------------------------------------------------------
// <copyright file="XmlFile.cs" company="https://github.com/marked-one/ScenesAndResolutionsPicker">
...
namespace EasyResolutions
{
    ...
    /// <summary>
    /// Represents operations on Easy Resolutions XML file.
    /// </summary>
    public class XmlFile
    {
        /// <summary>
        /// The name of Easy Resolutions XML file.
        /// </summary>
        private static string fileName = "easyresolutions.xml";

        /// <summary>
        /// Gets or sets Easy Resolutions XML file name.
        /// </summary>
