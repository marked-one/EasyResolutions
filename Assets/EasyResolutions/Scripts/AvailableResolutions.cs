...
namespace EasyResolutions
{
    ...
    public class AvailableResolutions : IAvailableResolutions
    {
        ...
        /// <see cref="EasyResolutions.AvailableResolutions"/> 
        ...
        /// <summary>
        /// Deserializes <see cref="EasyResolutions.AvailableResolutions"/> from <see cref="System.Xml.Linq.XElement"/>.
        /// </summary>
        ...
        /// <summary>
        /// Serializes <see cref="EasyResolutions.AvailableResolutions"/> to XML.
        /// </summary>
        ...
        /// <summary>
        /// Returns a <see cref="System.String"/> that represents the current <see cref="EasyResolutions.AvailableResolutions"/>.
        /// </summary>
        /// <returns>A <see cref="System.String"/> that represents the current <see cref="EasyResolutions.AvailableResolutions"/>.</returns>
        ...
        private bool ParseXml(XElement root)
        {
            ...
            if (!"EasyResolutions".Equals(root.Name.LocalName))
            {
                return false;
            }
        ...
        {
            var root = new XElement("EasyResolutions");
