...
namespace EasyResolutions
{
	...
	/// Scriptable object static adapter.	
	public class ScriptableObjectStaticAdapter : IScriptableObjectStatic
	{
		/// Creates an instance of ScriptableObject of specified type.
		public IScriptableObject<T> CreateInstance<T>() where T : ScriptableObject, IScriptableObject<T>
		{
