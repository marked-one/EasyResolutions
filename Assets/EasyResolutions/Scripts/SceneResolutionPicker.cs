...
namespace EasyResolutions
{
    ...
    {
        /// <summary>
        /// Gets or sets the object, which contains resolutions available for scenes.
        /// </summary>
        ...
        private static void LoadAvailableResolutions()
        {
            ...
            {
                Log.Info(string.Format("Availbale Easy Resolutions XML file was succesfully parsed.\nAvailable scenes and resolutions:\n{0}", availableResolutions));
            }
            else
            {
                Log.Warning(string.Format("Failed to parse availbale Easy Resolutions XML file.\nAvailable scenes and resolutions:\n{0}", availableResolutions));
            }
